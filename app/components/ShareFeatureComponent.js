...
App.ShareFeatureComponent = Em.Component.extend(App.TrackClickMixin, App.LanguagesMixin, {
    ...
    lineShare: Em.computed('title', function () {
    ...
    facebookShare: Em.computed('title', function () {

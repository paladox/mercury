...
import UA from './trackers/universal-analytics'
...
export default class Ads {
	 ...
	 */
	gaTrackAdEvent () {
		var adHitSample = 1, //Percentage of all the track requests to go through
		GATracker;

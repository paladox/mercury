 ...
 * @type {Ember.Object}
 */
var articleContentListeners = Ember.Object.create({
    initialized: false,
    containers: [],
    ...
    /**
     * This is a simple getter. It can't be a computed property because Ember.Object.create doesn't support thEmber.
     *
     * @return {JQuery}
     */
    ...
    onResize: function () {
        var containers = this.containers, containersCount = containers.length;

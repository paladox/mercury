...
var routes, unauthenticatedRoutes, authenticatedRoutes, articlePagePaths, proxyRoutePaths, unauthenticatedRouteConfig = {
    config: {
        cache: {
...
articlePagePaths.forEach(function (path) {
